...
class VggArgs(Adapter):
    ...
    def parse_args(self, args=None):
        ...
        parser.add_argument("--channels", type=tuple_list_parser(int) ,default=[(3,3)],
        ...
        parser.add_argument("--norms", default="BN", nargs="+", help="normlization layers")
        parser.add_argument("--activations", default="Relu", nargs="+", help="activate layers")
        parser.add_argument("--poolings", default="max_2-2-2", nargs="+", help="pooling layers, type_h_w_stride")
